  ...
  async function funct_send(){
    ...
    archivos.forEach(async (archivo) => {
      if (archivo.endsWith('.csv')) {
        ...
        // Cargamos el archivo JSON en el bucket de S3
        const params = {
          Bucket: bucketName,
          Key: nombreArchivoJson,
          Body: contenidoArchivoJson,
        };
        ...
        //Creamos los objetos de los ficheros que se han cambiado con formato 'json':Fichero
        //const formData = new FormData();
        /*formData.append('json', {
          uri: infoArchivoJson.uri,
          name: nombreArchivoJson,
          type: 'application/json',
          activityname: selectedActivity
        });*/

        
        //Envío de ficheros via API
        /*await fetch('http://192.168.1.133:8000/api/files/', {
          method:"POST",
          headers: {
       ...
       <Modal visible={showOptions} animationType="slide">
        ...
        <Text style={styles.text}>Registre la actividad que está realizando: </Text>
          ...
          <TouchableOpacity style={styles.modalButton} onPress={async () => {
            ...
            setSelectedActivity('Conducir coche');
            await funct_init();
            setShowOptions(false);
          }}>
          ...
          <TouchableOpacity style={styles.modalButton} onPress={async () => {
            ...
            setSelectedActivity('Subir o bajar escaleras');
            await funct_init();
            setShowOptions(false);
          }}>
